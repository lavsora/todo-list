          ...
          <g transform="translate(100.000000, 852.000000)">
            <g transform="translate(646.000000, 98.000000)">
              <g>
                ...
                <path
                  id={done ? 'icon-color-disabled' : 'icon-color-active'}
...
function Icon({ playTimer, done }) {
  if (playTimer) {
    return <IconPause done={done} />
  }

  return <IconPlay done={done} />
}
